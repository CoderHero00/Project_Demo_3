...
public class ApiUtils {
    ...
    private static final String PROJECT_BASE_USER_URL = "https://heroku-laravel-1900.herokuapp.com/api/";

    public static ApiServices getApiervice() {
        return RetrofitClient.getClient(PROJECT_BASE_USER_URL).create(ApiServices.class);
    }
